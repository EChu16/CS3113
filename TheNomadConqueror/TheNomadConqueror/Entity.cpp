...
alive(true), originalX(xPos), originalY(yPos), originalDir(startingDir), doubleJump(false), changedExp(false),randNum(0), walking(false), walkingTime(0.0f) {
...
float Entity::getWalkingTime() const { return walkingTime; }
...
bool Entity::isWalking() const { return walking; }
...
void Entity::changeWalking(bool iswalking) { walking = iswalking; }
void Entity::resetWalkingTime() { walkingTime = 0; }
